...
import telsamRoutes from './routes/telsam.routes.js';
...
import productFeedRoutes from './routes/productFeed.routes.js';
import caseTypeRoutes from './routes/caseType.routes.js';
import templateRoutes from './routes/template.routes.js';
import marketingRoutes from './routes/marketing.routes.js';
import smartSegmentRoutes from './routes/smartSegment.routes.js';
import contactGroupRoutes from './routes/contactGroup.routes.js';
import marketingV2Routes from './routes/marketingV2.routes.js';
import appNotesRoutes from './routes/appNotes.routes.js';
...
app.use('/api/telsam', telsamRoutes);
...
app.use('/api/workspaces', woocommerceRoutes);
app.use('/api/workspaces', productFeedRoutes);
app.use('/api/marketing', marketingRoutes);
app.use('/api/smart-segments', smartSegmentRoutes);
app.use('/api/contact-groups', contactGroupRoutes);
app.use('/api/marketing-v2', marketingV2Routes);
app.use('/api/app-notes', appNotesRoutes);
