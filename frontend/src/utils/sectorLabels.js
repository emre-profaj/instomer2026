...
export const SECTORS = {
    ...
    HEALTHCARE: {
        ...
        description: 'Bölümler, Branşlar ve Tedaviler hiyerarşisi',
        icon: '🏥',
        ...
        productGroupsTab: 'Branşlar',
        groupSingle: 'Branş',
        groupPlural: 'Branşlar',
        newGroup: 'Yeni Branş',
        allGroups: 'Tüm Branşlar',
        selectGroup: 'Branş Seçin',
        ungrouped: 'Branşsız',
        
        productsTab: 'Tedaviler',
        productSingle: 'Tedavi',
        productPlural: 'Tedaviler',
        productName: 'Tedavi Adı',
        newProduct: 'Yeni Tedavi Ekle',
        allProducts: 'Tüm Tedaviler',
        searchPlaceholder: 'Tedavi ara (örn: İmplant, Dolgu, Check-up)...',
        emptyProductsTitle: 'Tedavi Bulunamadı',
        emptyProductsDesc: 'Henüz tedavi eklenmemiş veya filtrelere uygun sonuç yok.',
        emptyGroupsTitle: 'Henüz branş bulunmuyor',
        emptyGroupsDesc: 'Tedavilerinizi branşlara ayırmak için (örn: KBB, Kardiyoloji, Diş) yeni branş ekleyin.'
    },
