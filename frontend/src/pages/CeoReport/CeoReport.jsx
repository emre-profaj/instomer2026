...
const CeoReport = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            // Daily stats (non-blocking — independent)
            const secondaryParams = { ...dateParams };
            if (funnelFilter) secondaryParams.funnelId = funnelFilter;

            contactAPI.getDailyStats(currentWorkspace.id, secondaryParams)
                .then(r => setContactStats(r.data))
                .catch(e => console.warn('Daily stats failed:', e.message));
