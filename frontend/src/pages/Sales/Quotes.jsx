...
const Quotes = () => {
    ...
    const handleSaveDeal = async (e) => {
        ...
        try {
            ...
            console.error('Failed to save deal:', error?.response?.data || error);
            alert('Teklif kaydedilemedi: ' + (error?.response?.data?.error || error.message || 'Bilinmeyen hata'));
        }
    };
    ...
    const updateProduct = (index, field, value) => {
        ...
        if (field === 'name') {
            ...
            // Auto-fill all details from catalog
                    ...
                    <>
                        ...
                        <div className="sales-detail-card">
                            ...
                            <div className="detail-info">
                                ...
                                {/* Kaynak — teklifte seçilen kaynak siparişe ve faturaya
                                    aynı kayıt üzerinden taşınır. */}
                                <div className="info-row">
                            ...
                            <div className="form-group products-section">
                                ...
                                {formData.products.map((product, index) => (
                                    <div key={index} style={{ border: '1px solid #e2e8f0', borderRadius: '10px', padding: '12px', marginBottom: '10px', background: '#fafbfc' }}>
                                        ...
                                        {/* Product detail card - shows when catalog product is matched */}
