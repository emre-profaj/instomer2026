...
import { Search, TrendingUp, FileText, X, Trash2, Receipt, Download, Plus } from 'lucide-react';
import './Sales.css';
        ...
        <div className="sales-page">
            ...
            <div className="sales-stats">
                <div className="stat-card">
                    <div className="stat-icon quote" style={{ background: 'rgba(16, 185, 129, 0.1)', color: '#10b981' }}>
                        <Receipt size={20} />
                    </div>
                ...
                <div className="stat-card">
                    <div className="stat-icon conversion" style={{ background: 'rgba(99, 102, 241, 0.1)', color: '#6366f1' }}>
                        <FileText size={20} />
                    </div>
                    <div className="stat-info">
                        <span className="stat-value">{stats?.totals?.invoices || 0}</span>
                        <span className="stat-label">Faturalandı</span>
                    </div>
                </div>
            </div>
                ...
                <div className="deals-list">
                    {loading ? (
                        ...
                        <div className="empty-state">
                            ...
                            <p>"Yeni Fatura" butonuna tıklayarak oluşturabilirsiniz</p>
                        </div>
                    ) : (
                            ...
                            >
                                <div className="deal-card-header">
                                    ...
                                    <span className={`deal-status ${deal.status.toLowerCase()}`}>
                                        {deal.status === 'OPEN' ? 'Bekliyor' : deal.status === 'WON' ? 'Ödendi' : 'İptal'}
                                    </span>
                                </div>
                                ...
                                <div className="deal-footer">
                                    ...
                                    <span className="deal-date">{new Date(deal.invoiceCreatedAt || deal.createdAt).toLocaleDateString('tr-TR')}</span>
                                </div>
                            </div>
                        ))
                    )}
                    ...
                    <div className="deal-detail-panel">
                        ...
                        <div className="detail-actions">
                            <button
                                ...
                                onClick={() => alert('PDF indirme yakında eklenecek')}
                            >
                                <Download size={16} />
                                PDF İndir
                            </button>
                        ...
                        <form onSubmit={handleCreateInvoice}>
                            ...
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    placeholder="Örn: Ocak Ayı Hizmeti"
                                    required
                                />
                            </div>
